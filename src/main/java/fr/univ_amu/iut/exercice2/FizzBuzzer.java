 ...
 * <b>triangulation</b>
 * : commencez par un retour en dur, puis généralisez dès qu'un deuxième test
 * vous y force.
 *
 * <p>
 * Règles : pour chaque entier {@code n},
 *
 * <ul>
 * <li>si {@code n} est multiple de 3 <em>et</em> de 5, retourner
 * {@code "FizzBuzz"}
